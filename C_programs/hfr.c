...
static int32_t adc1_accumulator [720000];
static int32_t adc2_accumulator [720000];
int main(int argc, char **argv)
{
	...
	*rst &= ~4;
	...
	for (j = 0;j<num_chirps;j++){
		...
		*rst |= 16;
		usleep(100); //give DDS more time to warm up
		printf("DDS reset \n");
